...
public abstract class ToxicFluid extends FlowableFluid {
    public Fluid getFlowing() {
        return ModFluids.TOXIC_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.TOXIC_STILL;
    }

    public Item getBucketItem() {
        return ModItems.TOXIC_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.TOXIC_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.TOXIC_STILL || fluid == ModFluids.TOXIC_FLOWING;
    }
    ...
    public static class Still extends ToxicFluid {
